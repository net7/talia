...
$Date: 2005/02/20 22:34:36 $, $Revision: 1.11 $, $Author: rahtz $
...
<xsl:template name="renderingInner">
 ...
 <!-- rendering value for indentation e align added
      by ILIESI-->
...
<xsl:template match="title">
  ...
  <!-- title by ILIESI--> 
  <xsl:template match="title[@type='work']">
    <xsl:apply-templates/>
  </xsl:template>  
  <xsl:template match="title[@type='opera']">
    <xsl:apply-templates/>
  </xsl:template> 
  <xsl:template match="title[@type='paragraph']">
    <xsl:apply-templates/>
  </xsl:template> 
  <xsl:template match="title[@type='summary']">
    <xsl:apply-templates/>
  </xsl:template>
  <!-- end ILIESI-->

...
2001/10/01 $, $Revision: 1.8 $, $Author: rahtz $
...
<xsl:template match="moduleSpec[@type='decls']" />

<xsl:template match="/TEI.2">
<xsl:choose>
  <xsl:when test=".//schemaSpec">
...
-->
	  ...
	  <xsl:apply-templates mode="tangle" select="specGrpRef"/>
  	  <xsl:apply-templates mode="tangle" select="moduleRef"/>
  	  <xsl:apply-templates mode="tangle"
			       select="elementSpec[@mode='add']"/>
  	  <xsl:apply-templates mode="tangle"
			       select="macroSpec[@mode='add']"/>
  	  <xsl:apply-templates mode="tangle"
			       select="classSpec[@mode='add']"/>
	    <xsl:choose>
...
<xsl:template match="specGrpRef" mode="tangle">

...
iip_root_directory_location: /usr/local/discovery/sophiavision_iip
start_page_editions: 
- facsimile
- critical
- categories
...
static_data_prefix: http://static.sophiavision.local
auto_ontologies: false
data_directory_location: /usr/local/discovery/sophiavision_data

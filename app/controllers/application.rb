...
class ApplicationController < ActionController::Base
  ...
  %w( source expression_card catalog facsimile_edition critical_edition manifestation book page paragraph chapter facsimile text_reconstruction transcription ).each do |klass|

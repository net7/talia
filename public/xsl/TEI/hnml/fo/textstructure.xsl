...
<!-- behaviour depends on the nesting level of <div> elements -->
  ...
  <xd:doc>
    <xd:short>Process elements  div0|div1|div2|div3|div4</xd:short>
    <xd:detail>&#160;</xd:detail>
  </xd:doc>
  ...
  <xd:doc>
    ...
    div0|div1|div2|div3|div4 (toc mode)</xd:short>
    <xd:detail>&#160;</xd:detail>
  </xd:doc>
  <xsl:template match="div0|div1|div2|div3|div4" mode="toc" >
    <xsl:call-template name="tocheading">
      <xsl:with-param name="level">
        <xsl:value-of select="substring-after(local-name(),'div')"/>
      </xsl:with-param>
  ...
  <xd:doc>
    <xd:short>Process elements  div0|div1|div2|div3|div4
    (xref mode)</xd:short>
    <xd:detail>&#160;</xd:detail>
  </xd:doc>
...
<xd:doc>
    <xd:short>Process elements  div[@type='dedication']</xd:short>
    <xd:detail>&#160;</xd:detail>
  </xd:doc>

...
<xd:doc type="stylesheet">
    ...
    <xd:cvsId>$Id: tei-param.xsl,v 1.1 2006/02/16 15:31:45 giacomi Exp $</xd:cvsId>
...
<xsl:param name="outputXHTML">true</xsl:param>
...
<xsl:param name="standardSuffix">
    <xsl:choose>
      ...
      <xsl:when test="teiCorpus.2">.xhtml</xsl:when>

...
function _renderButtons() { /* questa funzione è quella che scrive il link in basso e in alto */ /*sembra ok */
    var uo;
    if (currNode == root) {
        uo = "TEST";
    } else {
...
if (typeof window.onload != 'function')
{
    ...
    window.onload = function () { func(); main(); };
}
